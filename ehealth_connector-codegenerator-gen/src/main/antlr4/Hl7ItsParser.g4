...
parser grammar ITSParser;

options { tokenVocab=ITSLexer; }

/**document    :   prolog? misc* template misc*;
 *
 * prolog      :   XMLDeclOpen attr* SPECIAL_CLOSE ;
 */
...
attr   :   Name '=' AttrValue ; // Our STRING is AttValue in spec

nameAttr   :   NAMEATTR AttrValue ; // Our STRING is AttValue in spec
