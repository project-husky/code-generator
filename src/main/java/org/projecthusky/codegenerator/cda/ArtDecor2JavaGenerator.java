...
import org.projecthusky.codegenerator.cda.enums.ProcessModes;
import org.projecthusky.codegenerator.cda.model.CdaAttribute;
...
public class ArtDecor2JavaGenerator extends Hl7ItsParserBaseListener {
    ...
    private static void createField(final CompilationUnit compilationUnit,
        ...
        if ("hl7:typeId".contentEquals(cdaElement.getXmlName())) {
            dataType = "org.projecthusky.common.hl7cdar2.POCDMT000040InfrastructureRootTypeId";
        }
        Class<?> memberType =
    ...
    private static void createGetter(final CompilationUnit compilationUnit,
        ...
        if (isClassCollection(memberType)) {
            ...
            if ("effectiveTime".equals(name) && !isLocalField) {
                compilationUnit.addImport("org.projecthusky.common.hl7cdar2.SXCMTS");
                dataType = "SXCMTS";
            }
            if ("value".equals(name)) {
                compilationUnit.addImport("org.projecthusky.common.hl7cdar2.ANY");
                dataType = "ANY";
            }
            compilationUnit.addImport("java.util.List");
    ...
    private static void createInitVersionMethods(final CompilationUnit compilationUnit,
                                                 final ClassOrInterfaceDeclaration myClass) {
        compilationUnit.addImport("org.projecthusky.common.hl7cdar2.II");
        compilationUnit.addImport("org.projecthusky.common.hl7cdar2.INT");
            ...
            if (isClassCollection(memberType)) {
                ...
                if (memberType.getName().endsWith(".IVLTS") && !(dataType.endsWith(".IVLTS"))) {
                    if (memberType.getName().endsWith(".IVLTS") && (dataType.endsWith(".TS"))) {
                        ...
                        compilationUnit.addImport("org.projecthusky.common.hl7cdar2.IVLTS");
                        compilationUnit.addImport("org.projecthusky.common.hl7cdar2.ObjectFactory");
    ...
    private String adjustValueSet(final String value, final ClassOrInterfaceDeclaration myClass) {
        String retVal = value;
        String testEnum =
                value.replace(packageName + ".enums", "org.projecthusky.common.hl7cdar2");
        try {
        ...
        if (!(isField || isMethod)) {
            ...
            body.addStatement(
                    dataType
                            ...
                            + dataType.replace("org.projecthusky.common.hl7cdar2.", "")
                            + "();");
        }
        return method;
    }
            ...
            for (CdaAttribute cdaAttribute : cdaElement.getCdaAttributeList()) {
                ...
                if (cdaAttribute.getCodeList() != null) {
                    if (!cdaAttribute.getCodeList().isEmpty()) {
                        ...
                        compilationUnit.addImport("org.projecthusky.common.model.Code");
                        compilationUnit.addImport("org.projecthusky.common.basetypes.CodeBaseType");
    ...
    private void createFixedContentValues(
        ...
        if (this.isElementAConsumableWithNaMaterial(cdaElement)) {
            ...
            compilationUnit.addImport("org.projecthusky.common.hl7cdar2.POCDMT000040Consumable");
            compilationUnit.addImport(
                    "org.projecthusky.common.hl7cdar2.POCDMT000040ManufacturedProduct");
            compilationUnit.addImport("org.projecthusky.common.hl7cdar2.POCDMT000040Material");
    ...
    private void createJavaClassFile(CdaTemplate cdaTemplate, String packageName, String dstFilePath)
        ...
        for (CdaElement cdaElement : cdaTemplate.getCdaElementList()) {
            ...
            if (myClass.getAnnotationByClass(Generated.class).isEmpty()) {
                ...
                generated.addPair(
                        ...
                        new StringLiteralExpr(
                                "org.projecthusky.codegenerator.cda.ArtDecor2JavaGenerator"));
            ...
            if ("org.projecthusky.common.hl7cdar2.AD".equals(inheritanceOf)) {
                inheritanceOf = null;
            }
            ...
            if ("org.projecthusky.common.hl7cdar2.POCDMT000040ClinicalDocument"
                    .equals(cdaElement.getDataType())) {
    ...
    public void enterAttribute(final Hl7ItsParser.AttributeContext ctx) {
        ...
        Hl7ItsParser.ValueAttrContext valueAttrCtx = ctx.valueAttr();
        if (valueAttrCtx != null)
            currentCdaAttribute.setValue(valueAttrCtx.AttrValue().getText().replace("\"", ""));

        Hl7ItsParser.DataTypeAttrContext dataTypeAttrCtx = ctx.dataTypeAttr();
    ...
    public void enterElement(final Hl7ItsParser.ElementContext ctx) {
        ...
        Hl7ItsParser.MaxOccursAttrContext maxOccursAttrCtx = ctx.maxOccursAttr();
        if (maxOccursAttrCtx != null)
            maxOccursStr = maxOccursAttrCtx.AttrValue().getText().replace("\"", "");

        Hl7ItsParser.MinOccursAttrContext minOccursAttrCtx = ctx.minOccursAttr();
        if (minOccursAttrCtx != null)
            minOccursStr = minOccursAttrCtx.AttrValue().getText().replace("\"", "");

        Hl7ItsParser.ConformanceAttrContext conformanceAttrCtx = ctx.conformanceAttr();
        ...
        Hl7ItsParser.ContainsAttrContext containsAttrCtx = ctx.containsAttr();
        String ref = "";
    ...
    public void enterInclude(final Hl7ItsParser.IncludeContext ctx) {
        final Hl7ItsParser.RefAttrContext refAttrCtx = ctx.refAttr();
        String ref = "";
        if (refAttrCtx != null) {
    ...
    private boolean existAdderOrSetter(final ClassOrInterfaceDeclaration myClass, final CdaElement cdaElement) {
        ...
        if (!setterList.isEmpty() || !adderList.isEmpty()) {
            ...
            if ("org.projecthusky.common.hl7cdar2.EIVLTS".equals(dataType)) {
                dataType = "org.projecthusky.common.hl7cdar2.IVLTS";
            }
    ...
    private String getDataType(final CdaElement cdaElement, final Map<String, CdaTemplate> templateIndex)
        ...
        if (retVal == null && parentDataType.startsWith("org.projecthusky.common.hl7cdar2")) {
            retVal = parentDataType;
        }
        if (retVal == null) {
            throw new RuntimeException(
    ...
    private String getDataType(String parentClassName, String cdaElementName)
        ...
        if (retVal == null && parentClassName.endsWith(".AD")) {
            retVal = "org.projecthusky.common.hl7cdar2.ADXP";
        }
